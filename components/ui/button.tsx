  ...
  "group flex flex-row items-center justify-center rounded-md web:ring-offset-background web:transition-colors web:focus-visible:outline-none web:focus-visible:ring-2 web:focus-visible:ring-ring web:focus-visible:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        outline: "border border-input bg-background web:hover:bg-muted active:opacity-80",
        secondary: "bg-secondary web:hover:opacity-80 active:opacity-80",
        ghost: "web:hover:bg-muted active:opacity-80",
      ...
      size: {
        ...
        icon: "h-10 w-10",
        // No fixed height/padding — use className for full control on native + web.
        none: "",
      },
    },
    defaultVariants: {
    ...
    >
      <Pressable
        className={cn(
          ...
          className,
          // Always win over caller className so content stays centered.
